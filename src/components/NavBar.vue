...
<template>
  <nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
      <div
        class="d-grid navbar-collapse justify-content-lg-between justify-content-end"
      ...
      >
        ...
        <div class="right-items">
          <div class="d-none d-lg-block header-item" ref="notifaction">
          ...
          <div class="d-none d-lg-block header-item" ref="message">
            <div style="cursor: pointer" class="icon-not">
              <div class="Icon-notify">1</div>
          ...
          <div class="d-none d-lg-block header-item" ref="user">
            <div class="user">
              <div
                class="image"
